...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-[#060d1a] text-gray-900 dark:text-gray-100 pt-20 ">
      <Navbar />
      
      <div className="flex-1 max-w-7xl mx-auto w-full px-4 py-4 md:py-8 flex flex-col md:flex-row gap-4 md:gap-8">
        
        <aside className="w-full md:w-56 shrink-0 sticky top-16 md:top-24 z-20">
          <div className="card p-2 bg-white dark:bg-[#0c1427] md:bg-transparent md:dark:bg-transparent border border-gray-200 dark:border-white/5 md:border-none shadow-sm md:shadow-none rounded-xl md:rounded-none">
            
            <p className="hidden md:block text-[10px] font-bold text-gray-400 uppercase tracking-widest px-3 py-2">
              Admin Panel
            </p>
            
            <nav className="flex flex-row md:flex-col gap-1 overflow-x-auto md:overflow-visible pb-1 md:pb-0 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              {adminLinks.map((link) => (
                <Link 
                  key={link.to} 
                  to={link.to}
                ...
                >
                  {/* Added shrink-0 to prevent the SVG from squishing on small mobile screens */}
